...
export default function Page() {
  return (
    <div className="flex h-full items-center justify-center bg-gray-50 p-6 text-gray-900">
      <div className="flex max-w-md flex-col gap-6">
        ...
        <p className="leading-relaxed text-gray-600">
          ...
          gray color palette, and Hugeicons. This placeholder confirms the
          design system renders from the first page.
        </p>
